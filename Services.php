...
<head>
    ...
    <title>RAJ Hotel | Our room</title>
                            ...
                            <div class="row">
                                <div class="col-md-2 col-sm-2 col-xs-12">
                                    <div class="logo mt-15">
                                        <a href="index.php"><img src="images/logo/logo.jpeg" alt=""></a>
                                    </div>
                                </div>
                                            ...
                                            <ul>
                                                    ...
                                                    <li><a href="Services.php">Services<i class="fa fa-angle-down"></i></a>
                                                        <ul class="dropdown_menu">
                                                            ...
                                                            <li><a href="room-booking.php"> Book Now</a></li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="single-services">
                                <div class="services-img">
                                    <img src="images/services/services1-1.jpg" alt="">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="single-services">
                                <div class="services-img">
                                    <img src="images/services/services2-2.jpg" alt="">
                                    <div class="services-title">
                            ...
                            <div class="container">
                                    ...
                                    <div class="row slideanim">
                                      <div class="row">
                                          <div class="col-md-4">
                                            <div class="thumbnail">
                                                <img class="demo cursor" src="images/services/res.jpg" style="width:100%" onclick="currentSlide(1)" alt="Restaurant">
                                                <div class="caption">
                                                <h3>Restaurant</h3>
                                                    <p>Hotel Buyuk Keban is famous for its breakfast. We have a delicious open buffet with daily precuts and fresh ingredients. Even the pickiest eater is sure to find something to enjoy.
                                                    </p>
                                            </div>
                                          </div>
                                          </div>
                                          <div class="col-md-4">
                                            <div class="thumbnail">
                                                <img class="demo cursor" src="images/services/meet.jpg" style="width:100%" onclick="currentSlide(2)" alt="Meeting Rooms">
                                                <div class="caption">
                                                <h3>Meeting Rooms</h3>
                                                <p>Our hotel has two meeting rooms that are ready to host any of your events, such as; training programs, conferences, meetings, receptions or anything else you might need.
                                                </p>
                                            </div>
                                            </div>
                                          </div>
                                          <div class="col-md-4">
                                            <div class="thumbnail">
                                                <img class="demo cursor" src="images/services/bar2.jpg" style="width:100%" onclick="currentSlide(3)" alt="Bar">
                                                <div class="caption">
                                                <h3>Bar</h3>
                                                <p>Located next to the lobby, our Buyuk Keban Bar offers variety of Local and International Drinks as well as non-alcoholic beverages and tea & coffee selection.
                                                </p>
                                            </div>
                                            </div>
                                          </div>
                              ...
                              <div class="row slideanim">
                                      <div class="row">
                                          <div class="col-md-4">
                                            <div class="thumbnail">
                                                <img class="demo cursor" src="images/services/gym.jpg" style="width:100%" onclick="currentSlide(4)" alt="Gym">
                                                <div class="caption">
                                                <h3>Gym</h3>
                                                <p>Some gyms may offer a variety of additional programs and services, such as nutrition advice, weight loss challenges, lifestyle seminars, boot camp, walking groups and personal training.
                                            </p>
                                            </div>
                                            </div>
                                          </div>
                                          <div class="col-md-4">
                                            <div class="thumbnail">
                                                <img class="demo cursor" src="images/services/spa.jpg" style="width:100%" onclick="currentSlide(5)" alt="Spa">
                                                <div class="caption">
                                                <h3>Spa</h3>
                                                <p>
                                                Spa has been practiced everywhere over the centuries and each culture uses its own special techniques.Alleviate the stress of travel or relax after a long day of exploring the city in our hammam, or traditional Turkish bath.
                                                </p>
                                            </div>
                                            </div>
                                          </div>
                                          <div class="col-md-4">
                                            <div class="thumbnail">
                                                <img class="demo cursor" src="images/services/int1.jpg" style="width:100%" onclick="currentSlide(6)" alt="Internet Corner">
                                                <div class="caption">
                                                <h3>Internet Corner</h3>
                                                <p>
                                                The Internet corner is located in the lobby stage, right next to our reception desk. There are two computers available for your convenience & WIFI service.Access to the Internet Corner is free of charge and available 24/7.
                                                </p>
                                            </div>
                                            </div>
                                          </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-8 col-xs-12">
                        <p>Copyright© RAJ 2018.All right reserved.Created by </p>
                    </div>
