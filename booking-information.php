...
<head>
    ...
    <title>RAJ Hotel | Booking Done</title>
                    ...
                    <div class="col-md-12">
                        <div class="booking-rooms-tab">
                            <ul class="nav" role="tablist">
                                <li  class="#active"><a href="#booking" data-toggle="tab"><span class="tab-border">1</span><span> Booking </span></a></li>
                                <li><a href="#personal" data-toggle="tab"><span class="tab-border">2</span><span>Personal</span></a></li>
                                <li><a href="#payment" data-toggle="tab"><span class="tab-border">3</span><span>payment </span></a></li>
                                <li><a href="#done" data-toggle="tab"><span class="tab-border">4</span><span> Booking Done</span></a></li>
                                <li><a href="#done" data-toggle="tab"><span class="tab-border">5</span><span> Records</span></a></li>
                                    ...
                                    <div class="booking-info-deatils">
                                          <div class="single-room-details fix">
                                            ...
                                            <div class="single-room-details pl-50">
                                                <h3 class="s_room_title">SINGLE BED</h3>
                                            ...
                                            <div class="single-room-details fix">
                                            <div class="room-img">
                                                <img src="images/room/room2-2.jpg" alt="">
                                            </div>
                                            <div class="single-room-details pl-50">
                                                <h3 class="s_room_title">DOUBLE BED</h3>
                                                <div class="room_price">
                                                    <h4>Total Price</h4>
                                                    <h5>$1550 <span>/per night</span></h5>
                                                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable</p>
                                                </div>
                                            </div>
                                            </div>
                                            ...
                                            <div class="single-room-details fix">
                                            <div class="room-img">
                                                <img src="images/room/room3-2.jpg" alt="">
                                            </div>
                                            <div class="single-room-details pl-50">
                                                <h3 class="s_room_title">KING BED</h3>
                                                <div class="room_price">
                                                    <h4>Total Price</h4>
                                                    <h5>$5550 <span>/per night</span></h5>
                                                    <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable</p>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <form action="#">
                                                    ...
                                                    <div class="single-form-part">
                                                        ...
                                                        <div class="submit-form">
                                                            <button type="submit"><a href="our-room.php">Check Availability</a></button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
