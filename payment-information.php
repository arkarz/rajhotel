                    ...
                    <div class="col-md-12">
                        ...
                        <div class="service-tab-desc text-left mt-60">
                            <div class="tab-content">
                                ...
                                <div role="tabpanel row" class="tab-pane active" id="payment">
                                <?php
                                    $conn=mysqli_connect("localhost","root","","login1");
                                    $query ="SELECT book.name,book.aadhar,book.category,book.checkin,payment.amount,
                                    FROM book
                                    INNER JOIN payment ON book.name=payment.cname;";
                                ...
                                <?php if($sqli_run)
                                {
                                    while($row = mysqli_fetch_array($sqli_run))
                                        {
                                ?>
