        ...
        <!-- search bar End -->
                    ...
                    <div class="col-sm-11 col-sm-offset-1">
                            ...
                            <div role="tabpanel row" class="tab-pane active" id="payment">
                                <form action="payment.php" method="POST" class="was-validated">
                                    <div class="payment-info row">
                                       <div class="col-sm-2"><input type="text" name="cname" placeholder="Card Holder Name"></div> 
                                       <div class="col-sm-2"><input type="text" name="cno" placeholder="Card Number"></div>
                                       <div class="col-sm-2"><input type="text" name="cvv" placeholder="Card CVV Number"></div>
                                       <div class="col-sm-2"><input type="text" name="amt" placeholder="Amount"></div> 
                                       <div class="col-sm-2"><input type="text" name="mnth" placeholder="Month"></div>
                                       <div class="col-sm-2"><input type="text" name="yr" placeholder="Year"></div>
                                       <div class="col-sm-1"></div>
                                    </div>  <br> <br>           
                                    <div class="payment-info row"> 
                                        <div class="col-sm-6"><div class="payment-card"><a href="#"><img src="images/logo/pay-card.png" alt=""></a></div></div> 
                                        <div class="col-sm-3"><input  type="submit" value="Pay Now"></div> <br><br>
                                        <div class="col-sm-3"></div>                    <br><br>                    <br><br>
                                    </div>
                                </form>      
                            </div>
                    </div>
